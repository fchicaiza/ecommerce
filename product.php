...
<?php
	...
	try{
		...
		echo "Ha habido un problema con la conexion: " . $e->getMessage();
	}
	        	...
	        	<div class="col-sm-9">
		            ...
		            <div class="row">
		            	...
		            	<div class="col-sm-6">
		            		...
		            		<p><b>Categoría:</b> <a href="category?category=<?php echo $product['cat_slug']; ?>"><?php echo $product['catname']; ?></a></p>
		            		<p><b>Descripción:</b></p>
