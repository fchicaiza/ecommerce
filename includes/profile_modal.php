    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Detalle de la transacción</b></h4>
            </div>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="firstname" class="col-sm-3 control-label">Primer Nombres</label>
                ...
                <div class="form-group">
                    <label for="lastname" class="col-sm-3 control-label">Aoellidos</label>
                ...
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Ávatar</label>
                ...
                <div class="form-group">
                    <label for="curr_password" class="col-sm-3 control-label">Clave Actual</label>
